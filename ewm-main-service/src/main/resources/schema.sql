...
create TABLE IF NOT EXISTS event_comments (
  ...
  CONSTRAINT FK_EVENT_COMMENT_EVENT_ID FOREIGN KEY (event_id) REFERENCES events (id) ON delete CASCADE,
  CONSTRAINT FK_EVENT_COMMENT_COMMENTATOR_ID FOREIGN KEY (commentator_id) REFERENCES users (id) ON delete CASCADE
);